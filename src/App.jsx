function App(){
  return(
    ...
    <div>
      ...
      <a src="https://in.linkedin.com/in/dijul-m-519a07254">  Dijul M</a>
      </span>
    ...
    <div className="max-w-3xl mx-auto p-6 bg-gradient-to-r from-teal-50 to-slate-300 rounded-2xl shadow-md mt-10 mb-10">
      ...
      <div className="text-sm text-gray-700">
        ...
        <ul className="list-disc list-inside">
          <li> Muthoot Institute of Technology and Science 2022-26</li>
          <li>CGPA 7.97</li>
          <li>Positions : Class representative, AV Team member at Media Club,</li>
          <li> Membership Team Member at ACM</li>
        </ul>
        <h3 className="font-semibold text-gray-900 pt-5">Higher Secondary</h3>
        <ul className="list-disc list-inside">
          <li>Kendriya Vidyalaya No-1 Kozhikode 2020-22</li>
          <li>91%</li>
        </ul>
      </div>
    </div>
 ...
 (frontend development) | Firebase (backend for data storage)</li>
          <li> Developing a mobile application that
 enhances safety by providing real-time alerts about nearby wild animals. Powered by the YOLO v11
